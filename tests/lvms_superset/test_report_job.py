...
class ReportJobTests(unittest.TestCase):
    ...
    def test_normalizes_optional_report_groups_for_form_entry(self) -> None:
        job = validate_report_job(
            {
                **self.valid(),
        ...
        self.assertEqual(job.report_groups, ("OU-HEM", "OU-MOTTAKMOLPAT"))
        self.assertEqual(job.report_groups_text(), "OU-HEM,OU-MOTTAKMOLPAT")
